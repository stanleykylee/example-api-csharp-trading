...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RollContractsResponse :  IEquatable<RollContractsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RollContractsResponse" /> class.
        /// </summary>
        /// <param name="errorText">Non-empty if the request failed.</param>
        /// <param name="contracts">contracts (required).</param>
        public RollContractsResponse(string errorText = default(string), Object contracts = default(Object))
        {
            // to ensure "contracts" is required (not null)
            if (contracts == null)
            {
                throw new InvalidDataException("contracts is a required property for RollContractsResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RollContractsResponse {\n");
        ...
        {
            return this.Equals(input as RollContractsResponse);
        }

        /// <summary>
        /// Returns true if RollContractsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RollContractsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RollContractsResponse input)
        {
            if (input == null)
                return false;
