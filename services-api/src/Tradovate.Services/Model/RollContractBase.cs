...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RollContractBase :  IEquatable<RollContractBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RollContractBase" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="forward">forward (required).</param>
        /// <param name="ifExpired">ifExpired.</param>
        public RollContractBase(string name = default(string), bool? forward = default(bool?), bool? ifExpired = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RollContractBase and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (forward == null)
            {
                throw new InvalidDataException("forward is a required property for RollContractBase and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RollContractBase {\n");
        ...
        {
            return this.Equals(input as RollContractBase);
        }

        /// <summary>
        /// Returns true if RollContractBase instances are equal
        /// </summary>
        /// <param name="input">Instance of RollContractBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RollContractBase input)
        {
            if (input == null)
                return false;
